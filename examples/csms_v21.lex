...
# ---- ChargePoint wiring ----------------------------------------
fn ge(en_value :: Str) -> Bool {
  not (en_value == "")
}

fn central_system() -> cp.ChargePoint {
  (((((((((((((((((((cp.new_v21("csms-v21-example") |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.boot_notification(), sch.validate_boot_notification_req, on_boot)
    ...
    cp.handler_with_schema(c, a.battery_swap(), sch.validate_battery_swap_req, on_battery_swap)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.notify_allowed_energy_transfer(), sch.validate_notify_allowed_energy_transfer_req, on_notify_allowed_energy_transfer)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.notify_periodic_event_stream(), sch.validate_notify_periodic_event_stream_req, on_notify_periodic_event_stream)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.open_periodic_event_stream(), sch.validate_open_periodic_event_stream_req, on_open_periodic_event_stream)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.close_periodic_event_stream(), sch.validate_close_periodic_event_stream_req, on_close_periodic_event_stream)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.get_der_control(), sch.validate_get_der_control_req, on_get_der_control)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.set_der_control(), sch.validate_set_der_control_req, on_set_der_control)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.clear_der_control(), sch.validate_clear_der_control_req, on_clear_der_control)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.notify_der_alarm(), sch.validate_notify_der_alarm_req, on_notify_der_alarm)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.notify_der_start_stop(), sch.validate_notify_der_start_stop_req, on_notify_der_start_stop)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.change_transaction_tariff(), sch.validate_change_transaction_tariff_req, on_change_transaction_tariff)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.notify_web_payment_started(), sch.validate_notify_web_payment_started_req, on_notify_web_payment_started)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.use_priority_charging(), sch.validate_use_priority_charging_req, on_use_priority_charging)
  }) |> fn (c :: cp.ChargePoint) -> cp.ChargePoint {
    cp.handler_with_schema(c, a.update_dynamic_schedule(), sch.validate_update_dynamic_schedule_req, on_update_dynamic_schedule)
  }
}
...
fn main() -> [net, io, time] Nil {
  let __lex_discard_1 := io.print("CSMS v2.1  ws://localhost:9002/ocpp/<charger-id>")
  let __lex_discard_2 := io.print("subprotocol: ocpp2.1   (bidirectional / DER / periodic-stream-aware)")
