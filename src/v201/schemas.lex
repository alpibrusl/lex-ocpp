...
fn id_token_info_schema() -> s.ModelSchema {
  {
    title: "IdTokenInfo", description: "",
    fields: [
      s.required_str("status",          [StrOneOf(en.all_authorization_status())]),
      s.optional(s.required_str("cacheExpiryDateTime", [StrNonEmpty])),
      s.optional(s.required_int("chargingPriority",    [])),
      s.optional(s.required_str("language1",           [StrMaxLen(8)])),
      s.optional(s.required_str("language2",           [StrMaxLen(8)])),
      s.optional(s.required_array("evseId",            KInt([]), [])),
    ],
  }
}
...
fn status_info_schema() -> s.ModelSchema {
  {
    ...
    fields: [
      s.required_str("reasonCode",          [StrNonEmpty, StrMaxLen(20)]),
      s.optional(s.required_str("additionalInfo", [StrMaxLen(512)])),
    ],
  }
}
...
fn boot_notification_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — BootNotification.req",
    fields: [
...
fn heartbeat_req_schema() -> s.ModelSchema {
  { title: "HeartbeatRequest",
    description: "OCPP 2.0.1 — Heartbeat.req",
    fields: [] }
}
...
fn authorize_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — Authorize.req",
    fields: [
...
fn status_notification_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — StatusNotification.req",
    fields: [
      s.required_str("timestamp",        [StrNonEmpty]),
...
fn transaction_event_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — TransactionEvent.req",
    fields: [
      s.required_str("eventType",    [StrOneOf(en.all_transaction_event())]),
      s.required_str("timestamp",    [StrNonEmpty]),
      s.required_str("triggerReason",[StrOneOf(en.all_trigger_reason())]),
...
fn meter_values_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — MeterValues.req",
    fields: [
      s.required_int("evseId",      [IntNonNegative]),
...
fn data_transfer_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — DataTransfer.req",
    fields: [
...
fn firmware_status_notification_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — FirmwareStatusNotification.req",
    fields: [
...
fn security_event_notification_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — SecurityEventNotification.req",
    fields: [
      s.required_str("type",      [StrNonEmpty, StrMaxLen(50)]),
      s.required_str("timestamp", [StrNonEmpty]),
      s.optional(s.required_str("techInfo", [StrMaxLen(255)])),
    ],
  }
}
...
fn reset_req_schema() -> s.ModelSchema {
  {
    title: "ResetRequest",
    description: "OCPP 2.0.1 — Reset.req",
    fields: [
...
fn request_start_transaction_req_schema() -> s.ModelSchema {
  {
    title: "RequestStartTransactionRequest",
    description: "OCPP 2.0.1 — RequestStartTransaction.req",
    fields: [
      s.optional(s.required_int("evseId", [IntNonNegative])),
      s.required_int("remoteStartId",  []),
      s.required_object("idToken",     id_token_schema()),
    ],
  }
}
...
fn request_stop_transaction_req_schema() -> s.ModelSchema {
  {
    title: "RequestStopTransactionRequest",
    description: "OCPP 2.0.1 — RequestStopTransaction.req",
    fields: [
      s.required_str("transactionId", [StrNonEmpty, StrMaxLen(36)]),
    ],
  }
...
fn trigger_message_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — TriggerMessage.req",
    fields: [
...
fn change_availability_req_schema() -> s.ModelSchema {
  {
    ...
    description: "OCPP 2.0.1 — ChangeAvailability.req",
    fields: [
      # OperationalStatusEnumType: "Inoperative" | "Operative"
      s.required_str("operationalStatus",
        [StrOneOf(["Inoperative", "Operative"])]),
      s.optional(s.required_object("evse", evse_schema())),
    ],
  }
}
...
fn all_request_validators() -> List[ActionValidator] {
  [
    ...
    { action: "SecurityEventNotification",     validator: validate_security_event_notification_req },
    { action: "Reset",                         validator: validate_reset_req },
    { action: "RequestStartTransaction",       validator: validate_request_start_transaction_req },
