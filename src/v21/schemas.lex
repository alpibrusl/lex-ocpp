...
fn boot_notification_req_schema() -> s.ModelSchema {
  { title: "BootNotificationRequest", description: "OCPP 2.1 — BootNotification.req", fields: [s.required_object("chargingStation", charging_station_schema()), s.required_str("reason", [StrOneOf(en.all_boot_reason())])] }
}
...
fn heartbeat_req_schema() -> s.ModelSchema {
  { title: "HeartbeatRequest", description: "OCPP 2.1 — Heartbeat.req", fields: [] }
}
...
fn authorize_req_schema() -> s.ModelSchema {
  { title: "AuthorizeRequest", description: "OCPP 2.1 — Authorize.req", fields: [s.required_object("idToken", id_token_schema()), s.optional(s.required_str("certificate", [StrMaxLen(5500)]))] }
}
...
fn status_notification_req_schema() -> s.ModelSchema {
  { title: "StatusNotificationRequest", description: "OCPP 2.1 — StatusNotification.req", fields: [s.required_str("timestamp", [StrNonEmpty]), s.required_str("connectorStatus", [StrOneOf(en.all_connector_status())]), s.required_int("evseId", [IntNonNegative]), s.required_int("connectorId", [IntNonNegative])] }
}
...
fn data_transfer_req_schema() -> s.ModelSchema {
  { title: "DataTransferRequest", description: "OCPP 2.1 — DataTransfer.req", fields: [s.required_str("vendorId", [StrNonEmpty, StrMaxLen(255)]), s.optional(s.required_str("messageId", [StrMaxLen(50)])), s.optional(s.required_str("data", []))] }
}
...
fn reset_req_schema() -> s.ModelSchema {
  { title: "ResetRequest", description: "OCPP 2.1 — Reset.req", fields: [s.required_str("type", [StrOneOf(en.all_reset_type())]), s.optional(s.required_int("evseId", [IntNonNegative]))] }
}
...
fn battery_data_schema() -> s.ModelSchema {
  { title: "BatteryData", description: "", fields: [s.required_int("evseId", [IntNonNegative]), s.required_str("serialNumber", [StrNonEmpty, StrMaxLen(50)]), s.required_float("soC", [FloatInRange(0.0, 100.0)]), s.required_float("soH", [FloatInRange(0.0, 100.0)]), s.optional(s.required_str("productionDate", [StrNonEmpty])), s.optional(s.required_str("vendorInfo", [StrMaxLen(500)]))] }
}

fn battery_swap_req_schema() -> s.ModelSchema {
  { title: "BatterySwapRequest", description: "OCPP 2.1 — BatterySwap.req", fields: [s.required_str("eventType", [StrOneOf(en.all_battery_swap_event())]), s.required_object("idToken", id_token_schema()), s.required_int("requestId", []), s.required_array("batteryData", KObject(battery_data_schema()), [ListNonEmpty])] }
}
...
fn notify_allowed_energy_transfer_req_schema() -> s.ModelSchema {
  { title: "NotifyAllowedEnergyTransferRequest", description: "OCPP 2.1 — NotifyAllowedEnergyTransfer.req", fields: [s.required_int("transactionId", []), s.required_array("allowedEnergyTransfer", KStr([StrOneOf(en.all_energy_transfer_mode())]), [ListNonEmpty])] }
}
...
fn periodic_event_stream_params_schema() -> s.ModelSchema {
  { title: "PeriodicEventStreamParams", description: "", fields: [s.required_int("interval", [IntInRange(1, 86400)]), s.required_int("values", [IntInRange(1, 100)])] }
}

fn open_periodic_event_stream_req_schema() -> s.ModelSchema {
  { title: "OpenPeriodicEventStreamRequest", description: "OCPP 2.1 — OpenPeriodicEventStream.req", fields: [s.required_object("constantStreamData", periodic_event_stream_params_schema())] }
}
...
fn close_periodic_event_stream_req_schema() -> s.ModelSchema {
  { title: "ClosePeriodicEventStreamRequest", description: "OCPP 2.1 — ClosePeriodicEventStream.req", fields: [s.required_int("id", [IntNonNegative])] }
}
...
fn stream_data_element_schema() -> s.ModelSchema {
  { title: "StreamDataElement", description: "", fields: [s.required_float("t", []), s.required_str("v", [StrMaxLen(2500)])] }
}

fn notify_periodic_event_stream_req_schema() -> s.ModelSchema {
  { title: "NotifyPeriodicEventStreamRequest", description: "OCPP 2.1 — NotifyPeriodicEventStream.req", fields: [s.required_int("id", [IntNonNegative]), s.required_str("pending", [StrNonEmpty]), s.required_str("basetime", [StrNonEmpty]), s.required_int("seqNo", [IntNonNegative]), s.required_array("data", KObject(stream_data_element_schema()), [ListNonEmpty])] }
}
...
fn get_der_control_req_schema() -> s.ModelSchema {
  { title: "GetDERControlRequest", description: "OCPP 2.1 — GetDERControl.req", fields: [s.required_int("requestId", []), s.optional(s.required_bool("isDefault")), s.optional(s.required_str("controlType", [StrOneOf(en.all_der_control_type())])), s.optional(s.required_str("controlId", [StrMaxLen(36)]))] }
}
...
fn set_der_control_req_schema() -> s.ModelSchema {
  { title: "SetDERControlRequest", description: "OCPP 2.1 — SetDERControl.req", fields: [s.required_bool("isDefault"), s.required_str("controlId", [StrNonEmpty, StrMaxLen(36)]), s.required_str("controlType", [StrOneOf(en.all_der_control_type())])] }
}
...
fn clear_der_control_req_schema() -> s.ModelSchema {
  { title: "ClearDERControlRequest", description: "OCPP 2.1 — ClearDERControl.req", fields: [s.required_bool("isDefault"), s.optional(s.required_str("controlType", [StrOneOf(en.all_der_control_type())])), s.optional(s.required_str("controlId", [StrMaxLen(36)]))] }
}
...
fn notify_der_alarm_req_schema() -> s.ModelSchema {
  { title: "NotifyDERAlarmRequest", description: "OCPP 2.1 — NotifyDERAlarm.req", fields: [s.required_str("controlType", [StrOneOf(en.all_der_control_type())]), s.required_str("timestamp", [StrNonEmpty]), s.optional(s.required_str("gridEventFault", [StrMaxLen(255)])), s.optional(s.required_bool("alarmEnded")), s.optional(s.required_str("extraInfo", [StrMaxLen(200)]))] }
}
...
fn notify_der_start_stop_req_schema() -> s.ModelSchema {
  { title: "NotifyDERStartStopRequest", description: "OCPP 2.1 — NotifyDERStartStop.req", fields: [s.required_str("controlId", [StrNonEmpty, StrMaxLen(36)]), s.required_bool("started"), s.required_str("timestamp", [StrNonEmpty])] }
}
...
fn change_transaction_tariff_req_schema() -> s.ModelSchema {
  { title: "ChangeTransactionTariffRequest", description: "OCPP 2.1 — ChangeTransactionTariff.req", fields: [s.required_str("transactionId", [StrNonEmpty, StrMaxLen(36)]), s.required_str("tariffId", [StrNonEmpty, StrMaxLen(60)])] }
}
...
fn notify_web_payment_started_req_schema() -> s.ModelSchema {
  { title: "NotifyWebPaymentStartedRequest", description: "OCPP 2.1 — NotifyWebPaymentStarted.req", fields: [s.required_int("evseId", [IntNonNegative]), s.required_int("timeout", [IntNonNegative])] }
}
...
fn use_priority_charging_req_schema() -> s.ModelSchema {
  { title: "UsePriorityChargingRequest", description: "OCPP 2.1 — UsePriorityCharging.req", fields: [s.required_str("transactionId", [StrNonEmpty, StrMaxLen(36)]), s.required_bool("activate")] }
}
...
fn schedule_update_schema() -> s.ModelSchema {
  { title: "ScheduleUpdate", description: "", fields: [s.required_float("limit", []), s.optional(s.required_int("numberPhases", [IntInRange(1, 3)]))] }
}

fn update_dynamic_schedule_req_schema() -> s.ModelSchema {
  { title: "UpdateDynamicScheduleRequest", description: "OCPP 2.1 — UpdateDynamicSchedule.req", fields: [s.required_int("chargingProfileId", []), s.required_object("scheduleUpdate", schedule_update_schema())] }
}
