...
fn notify_allowed_energy_transfer() -> Str {
  "NotifyAllowedEnergyTransfer"
}

fn notify_periodic_event_stream() -> Str {
  "NotifyPeriodicEventStream"
}

fn notify_settlement() -> Str {
  "NotifySettlement"
}

fn notify_web_payment_started() -> Str {
  "NotifyWebPaymentStarted"
}

fn notify_der_alarm() -> Str {
  "NotifyDERAlarm"
}

fn notify_der_start_stop() -> Str {
  "NotifyDERStartStop"
}

fn report_der_control() -> Str {
  "ReportDERControl"
}

fn pull_dynamic_schedule_update() -> Str {
  "PullDynamicScheduleUpdate"
}

fn request_battery_swap() -> Str {
  "RequestBatterySwap"
}
...
fn adjust_periodic_event_stream() -> Str {
  "AdjustPeriodicEventStream"
}

fn open_periodic_event_stream() -> Str {
  "OpenPeriodicEventStream"
}

fn close_periodic_event_stream() -> Str {
  "ClosePeriodicEventStream"
}

fn get_periodic_event_stream() -> Str {
  "GetPeriodicEventStream"
}

fn get_der_control() -> Str {
  "GetDERControl"
}

fn set_der_control() -> Str {
  "SetDERControl"
}

fn clear_der_control() -> Str {
  "ClearDERControl"
}

fn change_transaction_tariff() -> Str {
...
fn clear_tariffs() -> Str {
  "ClearTariffs"
}

fn set_default_tariff() -> Str {
  "SetDefaultTariff"
}

fn update_dynamic_schedule() -> Str {
  "UpdateDynamicSchedule"
}

fn use_priority_charging() -> Str {
  "UsePriorityCharging"
}
